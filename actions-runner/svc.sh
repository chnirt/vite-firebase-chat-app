...
SVC_NAME="actions.runner.chnirt-vite-firebase-chat-app.Trinhs-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (chnirt-vite-firebase-chat-app.Trinhs-MacBook-Pro)"
